...
- `S3_PUBLIC_BASE_URL`: Optional stable public base URL for uploaded PDFs. If set, `parsePdf/upload` will construct public URLs as `${S3_PUBLIC_BASE_URL}/${key}`. Example: `https://storage.googleapis.com/<bucket>`
